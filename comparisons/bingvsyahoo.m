...
ylabel('Frequency')
title('Histogram of the Frequency of Difference in Response Times for Bing and Yahoo search')
print -depsc bingvsyahoo
print('bingvsyahoo', '-dpdf')

positive = findpositive(data);

pvalue = pvalue('bing', 'yahoo');