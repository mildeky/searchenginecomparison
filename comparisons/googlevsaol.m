...
ylabel('Frequency')
title('Histogram of the Frequency of Difference in Response Times for Google and AOL search')
print -depsc googlevsaol
print('googlevsaol', '-dpdf')

positive = findpositive(data);

pvalue = pvalue('google', 'aol');