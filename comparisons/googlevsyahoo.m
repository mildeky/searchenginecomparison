...
dataone = csvread('./../csv/google.csv', 0, 1, [0 1 999 1]);
datatwo = csvread('./../csv/yahoo.csv', 0, 1, [0 1 999 1]);
...
ylabel('Frequency')
title('Histogram of the Frequency of Difference in Response Times for Google and Yahoo search')
print -depsc googlevsyahoo
print('googlevsyahoo', '-dpdf')

positive = findpositive(data);

pvalue = pvalue('google', 'yahoo');