...
dataone = csvread('./../csv/aol.csv', 0, 1, [0 1 999 1]);
...
ylabel('Frequency')
title('Histogram of the Frequency of Difference in Response Times for AOL and Yahoo search')
print -depsc aolvsyahoo
print('aolvsyahoo', '-dpdf')

positive = findpositive(data);

pvalue = pvalue('aol', 'yahoo');