...
datatwo = csvread('./../csv/bing.csv', 0, 1, [0 1 999 1]);
...
ylabel('Frequency')
title('Histogram of the Frequency of Difference in Response Times for Google and Bing search')
print -depsc googlevsbing
print('googlevsbing', '-dpdf')

positive = findpositive(data);

pvalue = pvalue('google', 'bing');