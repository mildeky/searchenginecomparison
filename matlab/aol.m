...
data = csvread('./../csv/aol.csv', 0, 1, [0 1 999 1]);
figure(1); clf;
histogram(data, 200)
xlabel('Time to Respond (ms)')
ylabel('Frequency')
title('Histogram Relating the Frequency of Response Times for AOL Search')
print -depsc aolraw
print('aolraw', '-dpdf')
...
ylabel('Frequency')
title('Histogram Relating the Frequency of Log10 Response Times for AOL Search')
print -depsc aolnorm
print('aolnorm', '-dpdf')
