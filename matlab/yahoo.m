...
data = csvread('./../csv/yahoo.csv', 0, 1, [0 1 999 1]);
figure(1); clf;
histogram(data, 200)
xlabel('Time to Respond (ms)')
ylabel('Frequency')
title('Histogram Relating the Frequency of Response Times for Yahoo Search')
print -depsc yahooraw
print('yahooraw', '-dpdf')
...
ylabel('Frequency')
title('Histogram Relating the Frequency of Log10 Response Times for Yahoo Search')
print -depsc yahoonorm
print('yahoonorm', '-dpdf')
