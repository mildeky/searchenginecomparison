...
data = csvread('./../csv/google.csv', 0, 1, [0 1 999 1]);
figure(1); clf;
histogram(data, 200)
xlabel('Time to Respond (ms)')
ylabel('Frequency')
title('Histogram Relating the Frequency of Response Times for Google Search')
print -depsc googleraw
print('googleraw', '-dpdf')
...
ylabel('Frequency')
title('Histogram Relating the Frequency of Log10 Response Times for Google Search')
print -depsc googlenorm
print('googlenorm', '-dpdf')
